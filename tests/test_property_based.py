...
if not HYPOTHESIS_AVAILABLE:
    # Create placeholder to inform users
    @pytest.mark.skip(reason="hypothesis not installed (install with: pip install hypothesis)")
    def test_hypothesis_not_available():
        """Placeholder test to show hypothesis is not available."""
        pass
