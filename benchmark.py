...
def run_collection(test_dir: Path, use_fast: bool, collect_only: bool = True):
...
def benchmark_synthetic(num_files: int = 100, tests_per_file: int = 50):
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        # Warmup
        print("Warming up...")
        run_collection(test_dir, use_fast=True)
        ...
        fast_times = []
        for i in range(5):
            elapsed, result = run_collection(test_dir, use_fast=True)
